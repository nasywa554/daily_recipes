...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _deleteRecipe(int recipeId) async {
    ...
    if (user != null) {
      ...
      // if (deleteSavedResponse.error != null) {
      //   ScaffoldMessenger.of(context).showSnackBar(
      //     SnackBar(content: Text('Error deleting saved recipes: ${deleteSavedResponse.error!.message}')),
      //   );
      //   return; // Jika ada kesalahan, hentikan proses
      // }
      ...
      // } else {
      //   ScaffoldMessenger.of(context).showSnackBar(
      //     SnackBar(content: Text('Error deleting recipe: ${response.error!.message}')),
      //   );
      // }
    }
  }
